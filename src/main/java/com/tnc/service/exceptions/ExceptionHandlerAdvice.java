...
public class ExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ResponseBody
    public ApiError onConstraintViolationException(ConstraintViolationException constraintViolation) {
        ApiError error = new ApiError(HttpStatus.BAD_REQUEST, "Arguments validations failed");
...
//        return new ResponseEntity<>(new ApiError(HttpStatus.CONFLICT, ex.getMessage()));
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ResponseBody
    ApiError onShelterLocationException(ValidationException ex) {
